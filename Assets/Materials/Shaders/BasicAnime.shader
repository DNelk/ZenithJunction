...
Shader "BasicAnime"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aseld
			float dotResult2 = dot( normalize( (WorldNormalVector( i , normal19.rgb )) ) , ase_worldlightDir );
			float normal_lightdir9 = dotResult2;
			float2 temp_cast_1 = ((normal_lightdir9*_Scale + _Scale)).xx;
			float4 shadow13 = ( albedo26 * tex2D( _ToonRamp, temp_cast_1 ) );
			...
			#endif //aselc
			UnityGI gi35 = gi;
			float3 diffNorm35 = WorldNormalVector( i , normal19.rgb );
			...
			float dotResult5 = dot( normalize( (WorldNormalVector( i , normal19.rgb )) ) , ase_worldViewDir );
			...
			float dotResult66 = dot( ( ase_worldViewDir + _WorldSpaceLightPos0.xyz ) , normalize( (WorldNormalVector( i , normal19.rgb )) ) );
...
/*ASEBEGIN
Version=17000
1638;-339;986;721;3873.01;-4.604528;2.256334;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;65;-3600.798,625.0499;Float;False;19;normal;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;83;-2694.28,1040.262;Float;False;Property;_SpecTint;SpecTint;13;0;Create;True;0;0;False;0;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-2845.476,741.6072;Float;False;Property;_max;max;10;0;Create;True;0;0;False;0;1.12;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-2843.379,654.3231;Float;False;Property;_min;min;9;0;Create;True;0;0;False;0;1.1;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=FB8BC1A0D3B4A6493352060C423239B745297C58